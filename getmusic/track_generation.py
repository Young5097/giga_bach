...
def main():
    ...
    for file_name in file_list:
        ...
        if args.number == 0:
            save_path = os.path.join('/content/drive/MyDrive/giga_bach/APTITUDE/media/getmusic_result/midi0', file_name.split('/')[-1])
        elif args.number == 1:
            save_path = os.path.join('/content/drive/MyDrive/giga_bach/APTITUDE/media/getmusic_result/midi1', file_name.split('/')[-1])
        elif args.number == 2:
            save_path = os.path.join('/content/drive/MyDrive/giga_bach/APTITUDE/media/getmusic_result/midi2', file_name.split('/')[-1])
        else:
